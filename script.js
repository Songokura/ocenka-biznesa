...
var WA_TXT = {
  ...
  zalog:        "Здравствуйте! Пишу с сайта Центр Оценки.\nНаправление: оценка для залога в банке.\nОбъект, город и банк: ",
  msfo:         "Здравствуйте! Пишу с сайта Центр Оценки.\nНаправление: оценка для МСФО и аудита.\nАктивы и отчётная дата: ",
  kompleksy:    "Здравствуйте! Пишу с сайта Центр Оценки.\nНаправление: имущественный комплекс / производство.\nОбъект, город и цель оценки: ",
  oborudovanie: "Здравствуйте! Пишу с сайта Центр Оценки.\nНаправление: оборудование, спецтехника, транспорт.\nСостав объектов (кол-во позиций) и цель оценки: ",
  nedvizhimost: "Здравствуйте! Пишу с сайта Центр Оценки.\nНаправление: коммерческая недвижимость и земля.\nОбъект, площадь, город и цель оценки: ",
  nma:          "Здравствуйте! Пишу с сайта Центр Оценки.\nНаправление: НМА и интеллектуальная собственность.\nОбъект (товарный знак, ПО, патент) и цель оценки: ",
  debitorka:    "Здравствуйте! Пишу с сайта Центр Оценки.\nНаправление: дебиторская задолженность / финансовые инструменты.\nСостав и цель оценки: ",
  sdelki:       "Здравствуйте! Пишу с сайта Центр Оценки.\nНаправление: сделка, реорганизация, уставный капитал.\nОбъект и задача: ",
...
/* ---------------- БЕГУЩАЯ СТРОКА ОБЪЕКТОВ ---------------- */
var TICK = ["Доли и акции", "Заводы и фабрики", "Элеваторы", "Склады и логистика", "Нефтебазы и АЗС", "ТЦ и БЦ", "Гостиницы",
